...
#   filename:  types.json
#   timestamp: 2025-03-31T08:47:24+00:00
...
class MessageHighlight1(BaseModel):
    """
    ...
    citationId: Annotated[Optional[UUID], Field(title='citationId')] = None
    text: Annotated[str, Field(title='text')]


class MessageHighlight2(BaseModel):
    """
    Represents a text segment to be highlighted in the assistant's message.
    Used for visual emphasis in the displayed message.
    """
    ...
    color: Annotated[str, Field(title='color')]
    citationId: Annotated[Optional[UUID], Field(title='citationId')] = None
    startChar: Annotated[float, Field(title='startChar')]
    endChar: Annotated[float, Field(title='endChar')]


class MessageHighlight(RootModel[Union[MessageHighlight1, MessageHighlight2]]):
    root: Annotated[
        Union[MessageHighlight1, MessageHighlight2], Field(title='MessageHighlight')
    ]
    """
    Represents a text segment to be highlighted in the assistant's message.
    Used for visual emphasis in the displayed message.
...
class Citation1(BaseModel):
    ...
    id: Annotated[UUID1, Field(title='id')]
    messageHighlight: Annotated[MessageHighlight, Field(title='messageHighlight')]
    sourceHighlight: Annotated[PDFHighlight, Field(title='sourceHighlight')]
    messageId: Annotated[Optional[UUID], Field(title='messageId')] = None
    sourceId: Annotated[str, Field(title='sourceId')]
...
class Citation2(BaseModel):
    ...
    sourceHighlight: Annotated[PDFHighlight, Field(title='sourceHighlight')]
    messageId: Annotated[Optional[UUID], Field(title='messageId')] = None
    sourceIndex: Annotated[float, Field(title='sourceIndex')]


class Citation(RootModel[Union[Citation1, Citation2]]):
    root: Annotated[Union[Citation1, Citation2], Field(title='Citation')]
    """
    Links message highlights to their supporting evidence in source documents.
    Used to connect highlighted message parts with their source evidence.
    """
