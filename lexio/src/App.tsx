...
const MOCKED_RESPONSE = {
  ...
  answer: "# Foundations of Machine Learning through Physics\n\nPhysics has fundamentally influenced modern AI, as highlighted by the 2024 Nobel Prize in Physics. The laureates' work includes:\n\n1. Associative Memory with Hopfield Networks\n - Uses energy landscapes to store and recover patterns, mimicking magnetic spin interactions.\n - Enables retrieval of complete information from partial or noisy inputs.\n\n2. Boltzmann Machines and Deep Learning\n - Geoffrey Hinton’s innovation applied statistical physics (via Boltzmann’s equation) to build neural networks that learn from examples.\n - Laid the groundwork for deep neural networks that power today’s AI applications.\n\n3. Broad Impact on Technology and Research\n - Revolutionized tasks like image recognition, language translation, and data analysis.\n - Informed diverse fields, from particle physics to gravitational wave detection, by enabling advanced data processing.\n\nThese foundational contributions illustrate how physics has shaped the evolution of machine learning and continues to drive innovation in artificial intelligence."
};
